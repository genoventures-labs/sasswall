...
type Event struct {
	...
	PresenceTransition    string    `json:"presence_transition,omitempty"`
	PresenceSignatureID   string    `json:"presence_signature_id,omitempty"`
	PressureActionApplied string    `json:"pressure_action_applied,omitempty"`
